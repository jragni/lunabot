...
{
  new (message_memory) lunabot::msg::YoloV8Inference(_init);
}

void YoloV8Inference_fini_function(void * message_memory)
{
  auto typed_message = static_cast<lunabot::msg::YoloV8Inference *>(message_memory);
  typed_message->~YoloV8Inference();
}

size_t size_function__YoloV8Inference__yolov8_inference(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<lunabot::msg::InferenceResult> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<lunabot::msg::InferenceResult> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<lunabot::msg::InferenceResult> *>(untyped_member);
  return &member[index];
}
...
{
  const auto & item = *reinterpret_cast<const lunabot::msg::InferenceResult *>(
    get_const_function__YoloV8Inference__yolov8_inference(untyped_member, index));
  auto & value = *reinterpret_cast<lunabot::msg::InferenceResult *>(untyped_value);
  value = item;
}
...
{
  auto & item = *reinterpret_cast<lunabot::msg::InferenceResult *>(
    get_function__YoloV8Inference__yolov8_inference(untyped_member, index));
  const auto & value = *reinterpret_cast<const lunabot::msg::InferenceResult *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember YoloV8Inference_message_member_array[2] = {
  {
    ...
    offsetof(lunabot::msg::YoloV8Inference, header),  // bytes offset in struct
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<lunabot::msg::InferenceResult>(),  // members of sub message
    true,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(lunabot::msg::YoloV8Inference, yolov8_inference),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers YoloV8Inference_message_members = {
  ...
  2,  // number of fields
  sizeof(lunabot::msg::YoloV8Inference),
...
get_message_type_support_handle<lunabot::msg::YoloV8Inference>()
{
  return &::lunabot::msg::rosidl_typesupport_introspection_cpp::YoloV8Inference_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, lunabot, msg, YoloV8Inference)() {
  return &::lunabot::msg::rosidl_typesupport_introspection_cpp::YoloV8Inference_message_type_support_handle;
}
